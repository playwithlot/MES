...
//const static Pmt_ctr_cmd_map_t cmd_map[] =
//    {
//        {PMT_CTR_CMD_get_version, __pmt_get_version},
//        {PMT_CTR_CMD_set_resolution, __pmt_set_resolution},
//        {PMT_CTR_CMD_set_gating_time, __pmt_set_gating_time},
//        {PMT_CTR_CMD_test_comm, __pmt_test_comm},
//        {PMT_CTR_CMD_start_continue, __pmt_start_continue_mode},
//        {PMT_CTR_CMD_stop_and_clean, __pmt_stop_and_clean},
//        {PMT_CTR_CMD_start_once, __pmt_start_once},
//        {PMT_CTR_CMD_return_once, __pmt_return_once},
//};
